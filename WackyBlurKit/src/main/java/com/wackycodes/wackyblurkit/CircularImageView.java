...
Copyright 2022 - WackyCodes Design & Development
...
/**
 * This file is created by Shailendra lodhi
...
public class CircularImageView extends ImageView {
    ...
    // Default Values
    /**
     *  You can update default border width as you want!
     */
    private static final float DEFAULT_BORDER_WIDTH = 4;
    /**
     *  You can update default shadow radius as you want!
     */
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // Init Border
        if (attributes.getBoolean(R.styleable.CircularImageView_w_border, true)) {
            float defaultBorderSize = DEFAULT_BORDER_WIDTH * getContext().getResources().getDisplayMetrics().density;
            setBorderWidth(attributes.getDimension(R.styleable.CircularImageView_w_border_width, defaultBorderSize));
            setBorderColor(attributes.getColor(R.styleable.CircularImageView_w_border_color, Color.WHITE));
        }

        // Init Shadow
        if (attributes.getBoolean(R.styleable.CircularImageView_w_shadow, false)) {
            shadowRadius = DEFAULT_SHADOW_RADIUS;
            drawShadow(attributes.getFloat(R.styleable.CircularImageView_w_shadow_radius, shadowRadius), attributes.getColor(R.styleable.CircularImageView_w_shadow_color, shadowColor));
        }
