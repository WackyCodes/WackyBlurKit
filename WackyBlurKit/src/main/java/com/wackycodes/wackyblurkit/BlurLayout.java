...
public class BlurLayout extends FrameLayout {
    ...
    public BlurLayout( Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    /** Boolean value to set allow Running Blur */
    private boolean isAllowRunningAnim;
    ...
    private void initView( Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray attributes = context.getTheme().obtainStyledAttributes( attrs, R.styleable.BlurLayout, defStyleAttr, defStyleRes);

        try {
            mDownscaleFactor = attributes.getFloat(R.styleable.BlurLayout_blk_downscaleFactor, DEFAULT_DOWNSCALE_FACTOR);
            mBlurRadius = attributes.getInteger(R.styleable.BlurLayout_blk_blurRadius, DEFAULT_BLUR_RADIUS);
            mFPS = attributes.getInteger(R.styleable.BlurLayout_blk_fps, DEFAULT_FPS);
            mCornerRadius = attributes.getDimension(R.styleable.BlurLayout_blk_cornerRadius, DEFAULT_CORNER_RADIUS);
            mAlpha = attributes.getDimension(R.styleable.BlurLayout_blk_alpha, DEFAULT_ALPHA);
            isAllowRunningAnim = attributes.getBoolean(R.styleable.BlurLayout_blk_runBlur, false);
        } finally {
            attributes.recycle();
        }
...
//        setDownscaleFactor( mDownscaleFactor );
